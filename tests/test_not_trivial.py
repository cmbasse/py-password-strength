...
class NotTrivialTestCase(unittest.TestCase):
    ...
    def test_should_work_for_list_of_illegals(self):
        password_test = TrivialVariant(["apple", "bob"])
        self.assertEqual(password_test.test(PasswordStats("fred")), True)
        self.assertEqual(password_test.test(PasswordStats("bob")), False)
        self.assertEqual(password_test.test(PasswordStats("apple")), False)
        self.assertEqual(password_test.test(PasswordStats("applebob")), True)
